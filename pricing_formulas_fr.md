...
| | Essai | L’Enseigne | On tient la porte (recommandé) | Le créneau vide (upsell) |
| :--- | :--- | :--- | :--- | :--- |
| **Promesse** | Votre nom sur le design, 72 h | La porte, en ligne en 2 semaines | Photo WhatsApp le soir, site à jour | Le trou dans l’agenda |
| **Prix HTVA** | **0 €** | **1 990 €** | **199 € / mois** (12 mois), puis **99 €** | **+ 290 € / mois** sur On tient la porte |
| **Total si créneau vide** | — | — | — | **489 € / mois** |
| **Paiement** | — | Unique | Mensuel | Mensuel, après 8 semaines |
| **Affichage** | Bandeau au-dessus des cartes | Carte | Carte phare | Bandeau sous les cartes |

**Comparatif honnête (année 1)**

- L’Enseigne : 1 990 € HT une fois. Ensuite le client gère, ou hébergement seul **29 € HT / mois**.
...
**TTC (TVA 21 %)** — à ne pas afficher comme prix principal, utile en devis :

- L’Enseigne : 2 407,90 € TTC
...
## 00. Essai — bandeau (pas une carte tarif)

**« Votre nom sur le design que vous venez de cliquer »**

* **Prix :** **0 €**
* **Durée :** URL live **72 h**
* **Canal :** WhatsApp (4 photos + nom enseigne + lien design + commune)
* **Résumé :** Le prospect voit son enseigne sur le design choisi, la montre en salle, puis décide.

### Inclus
* Clone du design cliqué avec nom / adresse du prospect
* URL partageable 72 h
* Rappel dans la journée

### Non inclus
* Domaine définitif, hébergement long terme
* Modifications au-delà du premier habillage
* Fiche Google (inclus dans L’Enseigne)

### Copie bandeau
* Titre : **Essai · 0 €**
* Kicker : Avant de choisir
* Lead : Votre nom sur le design que vous venez de cliquer. URL live 72 h pour le montrer en salle.
* CTA : Envoyer 4 photos sur WhatsApp ↗

### Messages WhatsApp types (encoder pour wa.me)
...
## 01. L’Enseigne (ex-Lancement)

**« La porte, en ligne en 2 semaines »**

* **Prix :** **1 990 € HTVA**
* **Type de facturation :** Unique (50 % commande, 50 % mise en ligne)
* **Délai :** 10 jours ouvrés après textes, photos et accès
* **Résumé :** Le design choisi, à votre nom. Mobile, trouvé sur Google. Vous le possédez.

### Pour les restaurants
* Accueil, **menu**, à propos, contact
* Bouton réservation (téléphone, WhatsApp, ou widget déjà souscrit)
* Mise en avant des plats / de la salle

### Pour les barbiers
* Accueil, **services & tarifs**, à propos, contact
...
* Budget pub
* Mods après livraison → On tient la porte, ou 90 € HT / intervention
...
## 02. On tient la porte — carte recommandée (ex-Présence)

**« Photo WhatsApp le soir, site à jour »**

* **Prix :** **199 € HT / mois** pendant **12 mois**, puis **99 € HT / mois**
...
* Hébergement, HTTPS, sauvegardes
* **Photo WhatsApp → site à jour le soir** (+ 2 mods / mois)
* **4 posts Google Business** / mois
* Veille avis + modèle de réponse
* Rapport d’une page / mois (appels, clics itinéraire, réservations)
* E-mail sous 48 h ouvrées

### À partir du 13ᵉ mois
* **99 € HT / mois** : hébergement + 2 mods + Google (posts + avis)
* ou **29 € HT / mois** : hébergement seul, sans mods ni Google

### Non inclus
* Nouvelle page, refonte → devis
* Photos pro, pub payante, community Instagram / TikTok
* Le créneau vide avant 8 semaines de On tient la porte

### Cadre
* Engagement 12 mois, préavis 30 jours ensuite.
* Après 12 mois : le site est au client.
* Résiliation avant 12 mois : solde des mois restants **ou** rachat **990 € HT**.

### Copie carte
* Prix : **199 € HT** / mois
* Mention : 12 mois · L’Enseigne incluse · puis 99 € HT / mois
* 4 puces : L’Enseigne incluse · photo WhatsApp le soir · 4 posts Google · rapport (appels, itinéraire, réservations)

---

## 03. Le créneau vide — pas une 3ᵉ carte (ex-Croissance)

**« On vise le trou dans l’agenda »**

* **Prix :** **+ 290 € HT / mois** (On tient la porte reste due → **489 € HT / mois**)
* **Quand :** après **8 semaines** de On tient la porte (ou L’Enseigne déjà en ligne + 8 semaines de suivi)
* **Affichage :** bandeau sous la grille, jamais au même poids que L’Enseigne / On tient la porte

### Inclus (en plus de On tient la porte)
* SEO local : Maps, NAP, **1 page quartier ou service / trimestre**
* Gestion **Google Ads** locale (budget média **en sus**, reco 300–600 € / mois)
* Demande d’avis (QR + message type)
* 2 visuels / mois
* Point visio 30 min / mois

### Non inclus
* Budget Google / Meta
* Shooting, TikTok, influence
...
## Tableau comparatif (ce qui est à l’écran)

| Offre | Affichage | Prix HTVA | Paiement |
| :--- | :--- | :--- | :--- |
| **Essai** | Bandeau | 0 € | — |
